...
<div class="flex flex-col flex-1 gap-2">
    ...
    <div class={myClass}>
        ...
        {:else}
            <input class={`w-full rounded-lg border-0 outline-none ring-0 ps-3 ${disabled ? "bg-bgdark2":"bg-bgdark"} text-textdark text-[.9rem]`} id={name} {name} {disabled} {required}  {placeholder}
